...
Sources/control/%.o: ../Sources/control/%.c
	...
	avr-gcc -DDEBUG -Wall -g3 -O1 -fpack-struct -fshort-enums -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=at90pwm3b -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o"$@" "$<"
